...
*       - 멀티플랫폼: Windows, Linux, FreeBSD, OpenBSD, NetBSD, DragonFly,
*                        MacOS, 하이쿠, 안드로이드, 라즈베리 파이, DRM 네이티브, HTML5.
...
*       - 모델 셰이더 및 후처리 셰이더를 포함한 셰이더 지원
*       벡터, 행렬 및 쿼터니언 연산을 위한 강력한 수학 모듈: [레이매스]
